 ...
 */
export function generateRobotsTxt({ siteUrl = "https://fullremote-jobs.edounze.com" }) {
 ...
 */
export function generateLlmsTxt({ siteUrl = "https://fullremote-jobs.edounze.com" }) {
 ...
 */
export function generateLlmsFullTxt(jobs = [], { siteUrl = "https://fullremote-jobs.edounze.com" } = {}) {
 ...
 */
export function generateOpenApiSchema({ siteUrl = "https://fullremote-jobs.edounze.com" } = {}) {
  return {
    openapi: "3.0.1",
    info: {
 ...
 */
export function generateAiPluginManifest({ siteUrl = "https://fullremote-jobs.edounze.com" } = {}) {
  return {
    schema_version: "v1",
 ...
 */
export async function handleMcpRequest(request, env, ctx, { jobs = [], siteUrl = "https://fullremote-jobs.edounze.com" } = {}) {
  const corsHeaders = {
